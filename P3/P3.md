...
> **Defensa:** "El filtrado en cascada suma los retardos de ambos filtros ($M_{total} = M_1 + M_2$). Es más eficiente diseñar un único filtro Paso Banda de orden 100, ya que obtenemos la misma selectividad con la mitad de retardo y menos coste computacional."
...
> **Defensa:** "A mayor orden $M$, la pendiente de caída en la banda de transición es más vertical (el filtro es más selectivo). Sin embargo, esto aumenta el retardo y la complejidad del hardware."
