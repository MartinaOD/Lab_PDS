...
Los máximos de oscilación en la respuesta en frecuencia se producen en aquellas frecuencias donde la circunferencia unidad pasa próxima a polos del sistema, lo que incrementa la ganancia. Por el contrario, la presencia de ceros cercanos provoca mínimos o anulaciones en la respuesta.
En ese caso, la distancia al polo en el denominador es pequeña, lo que provoca un aumento de la magnitud. Si coincidieran exactamente, la respuesta tendería a infinito, lo que correspondería a un sistema inestable.

Por lo tanto, para su justificación, primero se han de buscar los polos de nuestro filtro (las raíces del denominador) para, posteriormente, obtener las frecuencias correspondientes en analógico.
...
<img width="732" height="149" alt="image" src="https://github.com/user-attachments/assets/6f777d66-154b-40c4-88f0-3cc526067a3c" />


* Si quisiéramos graficar los puntos junto con la respuesta del filtro, tendríamos algo tal que así:
```matlab
...
<img width="700" height="525" alt="oscilaciones_max_eliptico" src="https://github.com/user-attachments/assets/b20194c0-bfdc-4846-81cd-df9512f4fcb5" />

El diseño elíptico no pone el máximo justo en el polo, sino que hace que la ondulación en la banda de paso tenga máximos y mínimos alternados con la misma altura (equiripple).
Los ángulos de los polos indican las zonas donde la respuesta tiende a crecer, pero los máximos de la ondulación en la banda de paso de un filtro elíptico se determinan por la interacción conjunta de todos los polos y ceros, y por la condición de ondulación equiripple. Por eso, las frecuencias asociadas a los polos están próximas, pero no coinciden exactamente, con los máximos de la respuesta en frecuencia.

[PREGUNTAR POR ESTO A JAVIER:)]
...
![estabilidad0](https://github.com/user-attachments/assets/9298763f-9e94-49b1-9b49-15da66d2a916)
...
![estabilidad1](https://github.com/user-attachments/assets/ca23a235-b7ff-4e94-acba-2bee35f009ab)
...
![estabilidad2](https://github.com/user-attachments/assets/d6d606f0-e6ec-48ad-81c8-ade5d4b17aef)
