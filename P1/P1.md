...
Al reproducir ambas, notarás que la señal cuantificada tiene un "ruido de fondo" (hiseo). Esto se debe a que el error de cuantificación (la diferencia entre la onda suave y el escalón) se comporta como un ruido blanco aditivo.
