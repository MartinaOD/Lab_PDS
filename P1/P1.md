...
3. **Error visual:** Los marcadores muestran cómo la señal se discretiza en amplitud, perdiendo la suavidad de la onda original.
4. **Error cuantitativo:** El ECM nos da la potencia de ese ruido. A mayor número de bits decimales (D), menor será este valor de ECM.
